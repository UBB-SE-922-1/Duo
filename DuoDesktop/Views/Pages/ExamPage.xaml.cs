...
using static DuoDesktop.Views.Components.AssociationExercise;
using static DuoDesktop.Views.Components.MultipleChoiceExercise;
using static DuoDesktop.Views.Components.FillInTheBlanksExercise;
