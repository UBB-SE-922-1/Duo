// <copyright file="CreateFillInTheBlankExercise.xaml.cs" company="YourCompany">
...
namespace Duo.Views.Components.CreateExerciseComponents
{
    ...
    /// <summary>
    /// UserControl for creating fill-in-the-blank exercises.
    /// </summary>
    public sealed partial class CreateFillInTheBlankExercise : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFillInTheBlankExercise"/> class.
        /// </summary>
        public CreateFillInTheBlankExercise()
        {
            try
            {
            ...
            {
                _ = this.ShowErrorMessage("Initialization Error", $"Failed to initialize CreateFillInTheBlankExercise.\nDetails: {ex.Message}");
            }
        }
