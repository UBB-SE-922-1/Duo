// <copyright file="CreateFlashcardExercise.xaml.cs" company="YourCompany">
...
namespace Duo.Views.Components.CreateExerciseComponents
{
    ...
    /// <summary>
    /// UserControl for creating flashcard exercises.
    /// </summary>
    public sealed partial class CreateFlashcardExercise : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFlashcardExercise"/> class.
        /// </summary>
        public CreateFlashcardExercise()
        {
            try
            {
            ...
            {
                _ = this.ShowErrorMessage("Initialization Error", $"Failed to initialize CreateFlashcardExercise.\nDetails: {ex.Message}");
            }
        }
